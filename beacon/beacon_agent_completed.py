...
class BeaconAgent(base_agent.BaseAgent):
    ...
    def __init__(self):
        ...
        self.qlearn = QLearningTable(actions=list(range(len(smart_actions))),learning_rate=0.01, reward_decay=0.9)
        self.choice = ''
    ...
    def step(self, obs):
        ...
        if _MOVE_MARINE in obs.observation["available_actions"]:
            ...
            if not marine_y.any():
                # Since it is stuck inside the beacon, going to use last location
